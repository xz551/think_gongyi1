...
class UserModel extends Model
{
    ...
    {
        $sql = " SELECT u.uid,u.nickname,v.real_name,u.gender,u.email,u.qq,u.phone,v.idcard_code,u.type,u.`status`, v.`status` as  volunteer_status, u.create_date,server_tag from tb_user as u  LEFT JOIN tb_volunteer as v on u.uid=v.uid    where   ";
        ...
        if ($tags != '') {
            $where .= "  and concat(',',server_tag,',') like '%,$tags,%' ";
            ...
            $count_sql = " select count(0) as c from  tb_user as u  LEFT JOIN tb_volunteer as v on u.uid=v.uid  where " . $where;
        }
