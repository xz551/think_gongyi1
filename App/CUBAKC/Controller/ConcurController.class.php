...
class ConcurController extends Controller{
	 ...
	 * @creator zhu 
	 */
	public function ajaxGetConcur($uid,$type,$tag=0,$p=1,$pageSize=4){
	 ...
	 */
	public function ajaxGetConcur1($uid,$type,$tag=0,$p=1,$pageSize=1){
	 ...
	 * ajax返回我认证的真实求助信息
	 */
	public function ajaxApprove($uid,$tag=0,$p=1,$pageSize=1){
		//$uid认证的求助信息
